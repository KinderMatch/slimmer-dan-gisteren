...
const websites = [
  ...
  { title: "Nieuwbouw Makelaar Spanje", url: "https://www.nieuwbouwmakelaarspanje.com/", role: t("Website gemaakt in Wix door Slimmer dan Gisteren. Beheer door Slimmer dan Gisteren.", "Website built in Wix by Slimmer dan Gisteren. Managed by Slimmer dan Gisteren.", "Web creada en Wix por Slimmer dan Gisteren. Gestión por Slimmer dan Gisteren.") },
  ...
  { title: "CYB Training", url: "https://cybtraining.nl/", role: t("Website gemaakt door externe websitebouwer. Beheer en overdracht door Slimmer dan Gisteren.", "Website built by an external website builder. Management and transfer by Slimmer dan Gisteren.", "Web creada por un desarrollador externo. Gestión y traspaso por Slimmer dan Gisteren.") },
];
